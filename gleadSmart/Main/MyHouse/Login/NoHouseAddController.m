...
@interface NoHouseAddController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation NoHouseAddController{
    NSString *name;
    NSNumber *lon;
    NSNumber *lat;
...
- (void)setNavItem{
    ...
    [leftButton addTarget:self action:@selector(cancelAddFamily) forControlEvents:UIControlEventTouchUpInside];
...
- (UITableView *)addFamilyTable{
    if (!_addFamilyTable) {
        _addFamilyTable = ({
            ...
            [tableView registerClass:[AddFamilyTextCell class] forCellReuseIdentifier:CellIdentifier_noHouseAddFamilyText];
            [tableView registerClass:[AddFamilySelectCell class] forCellReuseIdentifier:CellIdentifier_noHouseAddFaminlySelect];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    switch (indexPath.section) {
        case 0:
        {
            AddFamilyTextCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier_noHouseAddFamilyText];
            cell.backgroundColor = [UIColor whiteColor];
            if (cell == nil) {
                cell = [[AddFamilyTextCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier_noHouseAddFamilyText];
            }
            if (indexPath.row == 0) {
        ...
        case 1:
        {
            AddFamilySelectCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier_noHouseAddFaminlySelect];
            if (cell == nil) {
                cell = [[AddFamilySelectCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier_noHouseAddFaminlySelect];
            }
